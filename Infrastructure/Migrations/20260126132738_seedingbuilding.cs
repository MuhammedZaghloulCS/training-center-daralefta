...
{
    /// <inheritdoc />
    public partial class seedingbuilding : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "system", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "مخصص للمحاضرات والدروس النظرية ويحتوي على قاعات مجهزة", "مبنى القاعات الدراسية", null, null },
                    { 3, "system", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "يحتوي على معامل الحاسب الآلي والمعامل العملية", "مبنى المعامل والتطبيقات", null, null },
                    { 4, "system", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "مسؤول عن تسجيل الطلاب وتقديم الخدمات الطلابية", "مبنى شؤون الطلاب", null, null },
                    { 5, "system", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "يضم الكافيتريا والخدمات العامة وقاعات الأنشطة", "مبنى الخدمات", null, null },
                    { 6, "system", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "يضم مكاتب الإدارة العليا والشؤون الإدارية والمالية", "المبنى الإداري الرئيسي", null, null }
                });
