...
{
    public class GetUsersSessionRangePaginatedHandler : IRequestHandler<GetUsersSessionRangePaginatedQuery, BaseResponse<List<UserDTO>>>


    {
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly IUnitOfWork _unitOfWork;
        public GetUsersSessionRangePaginatedHandler(UserManager<ApplicationUser> userManager, IUnitOfWork unitOfWork)
        {
            _userManager = userManager;
            _unitOfWork = unitOfWork;
        }
        public async Task<BaseResponse<List<UserDTO>>> Handle(
       GetUsersSessionRangePaginatedQuery request,
